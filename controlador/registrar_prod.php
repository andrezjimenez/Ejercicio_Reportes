...
$objProducto = new producto();
 $respuesta=$objProducto->registrar($conexion, $_POST['nombre'], $_POST['valor'], $_POST['cantidad'], $_POST['categoria']);
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      ...
      <main role="main" class="inner cover">
        ...
        <p class="lead">
            ...
            <button type="button" class="btn btn-primary btn-sm" onclick = "location='../RegistroProd.php'" > Volver </button>
        </p>
      </main>
