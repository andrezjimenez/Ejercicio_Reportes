...
<?php
	...
	$objq8 = new q8();
	$respuesta=$objq8->Eliminaranteriorq8($conexion);

	$objq82 = new q8();

	$carpeta = "files/";
    opendir($carpeta);
    $destino =$carpeta.$_FILES['Q8']['name'];
...
*/
	...
	for ($i = 1; $i <= $numRows; $i++) {
		...
		if($i>9){
			$respuesta=$objq8->agregarq8($conexion,$Choice,$Npersona1,$Npersona2,$Npersona3,$Npersona4,$Npersona5,$Npersona6,$Npersona7,$Npersona8,$Npersona9,$Npersona10,$Mean);
		}
    }
